...
import 'action_editor_from_creation_model.dart';
export 'action_editor_from_creation_model.dart';

class ActionEditorFromCreationWidget extends StatefulWidget {
  const ActionEditorFromCreationWidget({
    Key? key,
    this.currentAction,
    this.currentType,
  }) : super(key: key);
  ...
  @override
  _ActionEditorFromCreationWidgetState createState() =>
      _ActionEditorFromCreationWidgetState();
}

class _ActionEditorFromCreationWidgetState
    extends State<ActionEditorFromCreationWidget> {
  late ActionEditorFromCreationModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ActionEditorFromCreationModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<TypesRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final actionEditorFromCreationTypesRecord = snapshot.data!;
                        ...
                        if (_model.switchListTileValue3 ?? true)
                          TextFormField(
                            ...
                            onFieldSubmitted: (_) async {
                              final actionsUpdateData = createActionsRecordData(
                                commands: createCommandsStruct(
                                  sendEmailMessage: _model.textController5.text,
                                  clearUnsetFields: false,
                                ),
                              );
                              await widget.currentAction!.reference
