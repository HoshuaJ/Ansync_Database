  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<TypesRecord>>(
      stream: queryTypesRecord(
        queryBuilder: (typesRecord) => typesRecord.where('typeName',
            isEqualTo: widget.thingToDisplay!.typeId),
        singleRecord: true,
      ),
      builder: (context, snapshot) {
        ...
        List<TypesRecord> thingPageCopyTypesRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final thingPageCopyTypesRecord = thingPageCopyTypesRecordList.isNotEmpty
            ? thingPageCopyTypesRecordList.first
            : null;
        return Scaffold(
          key: scaffoldKey,
            ...
            child: GestureDetector(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    thingPageCopyTypesRecord!.typeName!,
