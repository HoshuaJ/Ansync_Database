...
import 'thing_page_new_model.dart';
export 'thing_page_new_model.dart';

class ThingPageNewWidget extends StatefulWidget {
  const ThingPageNewWidget({
    Key? key,
    this.thing,
  }) : super(key: key);
  ...
  @override
  _ThingPageNewWidgetState createState() => _ThingPageNewWidgetState();
}

class _ThingPageNewWidgetState extends State<ThingPageNewWidget> {
  late ThingPageNewModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ThingPageNewModel());
  }
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<TypesRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<TypesRecord> thingPageNewTypesRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final thingPageNewTypesRecord = thingPageNewTypesRecordList.isNotEmpty
            ? thingPageNewTypesRecordList.first
            : null;
                ...
                children: [
                  ...
                  Align(
                    ...
                    child: Padding(
                      ...
                      child: Text(
                        thingPageNewTypesRecord!.typeName!,
                        style:
                  ...
                  StreamBuilder<List<ActionsRecord>>(
                    stream: queryActionsRecord(
                      parent: thingPageNewTypesRecord!.reference,
