...
import 'type_creator_copy_copy_copy_model.dart';
export 'type_creator_copy_copy_copy_model.dart';

class TypeCreatorCopyCopyCopyWidget extends StatefulWidget {
  const TypeCreatorCopyCopyCopyWidget({
    Key? key,
    this.currentType,
  }) : super(key: key);
  ...
  @override
  _TypeCreatorCopyCopyCopyWidgetState createState() =>
      _TypeCreatorCopyCopyCopyWidgetState();
}

class _TypeCreatorCopyCopyCopyWidgetState
    extends State<TypeCreatorCopyCopyCopyWidget> {
  late TypeCreatorCopyCopyCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TypeCreatorCopyCopyCopyModel());
  }
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<UsersRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final typeCreatorCopyCopyCopyUsersRecord = snapshot.data!;
        return Scaffold(
          key: scaffoldKey,
                            ...
                            children: [
                              Padding(
                                ...
                                child: FlutterFlowIconButton(
                                  ...
                                  onPressed: () async {
                                    context.pushNamed('AdminCopyCopy');
                                  },
                                ),
                              ),
                              Padding(
