...
import 'log_page_from_new_model.dart';
export 'log_page_from_new_model.dart';

class LogPageFromNewWidget extends StatefulWidget {
  const LogPageFromNewWidget({
    Key? key,
    this.thing,
  }) : super(key: key);
  ...
  @override
  _LogPageFromNewWidgetState createState() => _LogPageFromNewWidgetState();
}

class _LogPageFromNewWidgetState extends State<LogPageFromNewWidget> {
  late LogPageFromNewModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LogPageFromNewModel());
  }
