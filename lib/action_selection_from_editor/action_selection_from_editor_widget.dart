...
import 'action_selection_from_editor_model.dart';
export 'action_selection_from_editor_model.dart';

class ActionSelectionFromEditorWidget extends StatefulWidget {
  const ActionSelectionFromEditorWidget({
    Key? key,
    this.currentType,
  }) : super(key: key);
  ...
  @override
  _ActionSelectionFromEditorWidgetState createState() =>
      _ActionSelectionFromEditorWidgetState();
}

class _ActionSelectionFromEditorWidgetState
    extends State<ActionSelectionFromEditorWidget> {
  late ActionSelectionFromEditorModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ActionSelectionFromEditorModel());
  }
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<TypesRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final actionSelectionFromEditorTypesRecord = snapshot.data!;
