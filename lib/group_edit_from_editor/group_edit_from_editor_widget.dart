...
import 'group_edit_from_editor_model.dart';
export 'group_edit_from_editor_model.dart';

class GroupEditFromEditorWidget extends StatefulWidget {
  const GroupEditFromEditorWidget({
    Key? key,
    this.currentType,
  }) : super(key: key);
  ...
  @override
  _GroupEditFromEditorWidgetState createState() =>
      _GroupEditFromEditorWidgetState();
}

class _GroupEditFromEditorWidgetState extends State<GroupEditFromEditorWidget> {
  late GroupEditFromEditorModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GroupEditFromEditorModel());
  }
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<TypesRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final groupEditFromEditorTypesRecord = snapshot.data!;
