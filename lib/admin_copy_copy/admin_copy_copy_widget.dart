...
export 'admin_copy_copy_model.dart';
...
class AdminCopyCopyWidget extends StatefulWidget {
  ...
  final TypesRecord? existingType;

  @override
  _AdminCopyCopyWidgetState createState() => _AdminCopyCopyWidgetState();
}

class _AdminCopyCopyWidgetState extends State<AdminCopyCopyWidget> {
  late AdminCopyCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdminCopyCopyModel());
                  ...
                  onPressed: () async {
                    context.pushNamed(
                      ...
                      extra: <String, dynamic>{
                        'currentType': widget.existingType,
                      },
                    );
                  },
                  text: 'Edit States',
