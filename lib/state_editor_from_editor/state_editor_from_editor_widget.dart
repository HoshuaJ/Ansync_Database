...
import 'state_editor_from_editor_model.dart';
export 'state_editor_from_editor_model.dart';

class StateEditorFromEditorWidget extends StatefulWidget {
  const StateEditorFromEditorWidget({
    Key? key,
    this.currentAction,
    this.currentType,
  }) : super(key: key);
  ...
  @override
  _StateEditorFromEditorWidgetState createState() =>
      _StateEditorFromEditorWidgetState();
}

class _StateEditorFromEditorWidgetState
    extends State<StateEditorFromEditorWidget> {
  late StateEditorFromEditorModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => StateEditorFromEditorModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<TypesRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final stateEditorFromEditorTypesRecord = snapshot.data!;
